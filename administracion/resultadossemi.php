...
$sqlpartidos = "select * from segundafase where anno = '$Y' and fasepartido = 'Semifinal' order by fecha asc, hora asc;";
...
$sqlpartidos1 = "select * from segundafase where anno = '$Y' and fasepartido = 'Semifinal' order by fecha asc, hora asc;";
...
<title>Resultados Semifinal</title>
<style>
#contenedor {
	width:1200px;
	height:auto;	
...
<table border="1" >
	...
	?> 
    <form action="actresultadossemi.php" method="post">   
   	<tr align="center">
