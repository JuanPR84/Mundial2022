...
$sqlpartidos = "select * from segundafase where anno = '$Y' and fasepartido = 'Cuartos' order by fecha asc, hora asc;";
...
$sqlpartidos1 = "select * from segundafase where anno = '$Y' and fasepartido = 'Cuartos' order by fecha asc, hora asc;";
...
<title>Resultados Cuartos</title>
<style>
#contenedor {
	width:1200px;
	height:auto;	
...
<table border="1" >
	...
	?> 
    <form action="actresultadoscuartos.php" method="post">   
   	<tr align="center">
