...
$sqlpartidos = "select * from segundafase where anno = '$Y' and fasepartido = 'Final' order by fecha asc, hora asc;";
...
$sqlpartidos1 = "select * from segundafase where anno = '$Y' and fasepartido = 'Final' order by fecha asc, hora asc;";
...
<table border="1" >
	...
	?> 
    <form action="actresultadosfinal.php" method="post">   
   	<tr align="center">
